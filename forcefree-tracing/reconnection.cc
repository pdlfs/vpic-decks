...
#define DUMP_DIR_FORMAT "/global/cscratch1/sd/xiaocan/Cori_tests/3D-Lx150-bg0.2-150ppc-2048KNL/%s"
...
begin_initialization {
  ...
  double taui    = 500.0/wpe_wce; // simulation wci's to run
  ...
  double dbz = 0.03*b0;                   // Perturbation in Bz rel. to Bo (Only change here)
